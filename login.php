                                            ...
                                            <ul>
                                                <li>
                                                    <div>
                                                        ...
                                                        <div><input type="email" name="email" id="email" value="" placeholder='이메일을 입력하세요!'></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div>
                                                        <label for="pwd">비밀번호</label>
                                                        <div><input type="password" name="pwd" id="pwd" value="" placeholder='비밀번호를 입력하세요!'></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div>
